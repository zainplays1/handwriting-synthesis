...
By default, math stitching now uses zero baseline jitter for stable placement; symbol primitives (`+`, `=`) keep a tiny hand-drawn variation, and you can add broader variation with `MathHandWriter(..., jitter_scale=...)`.
